...
<div class="container">
    <div name="registration" class="registration" align="center" style="border: 1px">
        <form id="registration">
            Логин<input type="text" required id="regLogin" name="regLogin" placeholder="Введите логин">
Пароль<input type="password" required id="regPassword" name="regPassword" placeholder="Введите пароль">
                </tr>
                <tr>
